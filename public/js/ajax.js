var myUser = {
    ...
    var getLocation = function (loc) {
        ...
        $.getJSON(call_url, function (data) {
            ...
            detailhtml = '<form class="put-location input-group" data-location="'+Location.data._id+'">'
                      + '<div class="input-group">'
                        + '<label>lng</label>'
                        + '<input name="lng" value="'+Location.data.latlng.lng+'" class="form-control"/><br/>'
                        + '<label>lat</label>'
                        + '<input name="lat" value="'+Location.data.latlng.lat+'" class="form-control"/><br/>'
                        + '<label>pokeid</label>'
    ...
    var newUser = function () {
        ...
        detailhtml = '<form class="post-location input-group">'
              + '<div class="input-group">'
                + '<label>lng</label>'
                + '<input name="lng" value="" class="form-control"/><br/>'
                + '<label>lat</label>'
                + '<input name="lat" value="" class="form-control"/><br/>'
                + '<label>pokeid</label>'
